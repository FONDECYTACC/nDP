...
path_in <- paste0(gsub("cons","", getwd()), "/data (1)/25082023_data_output")
full_path_in <- paste0(path_in,"/1_ndp_2023_08_30.Rdata")
...
#https://www.senda.gob.cl/tratamiento-de-drogas-para-adolescentes-un-apoyo-para-la-reinsercion/
#https://www.studocu.com/cl/document/universidad-arturo-prat/psicologia-clinica/entrevista-kt-implementacion/5380814
#Lo dividimos por población entonces está el convenio 1 que atiende a personas a dultas, población general no especifica mujeres, y ahí hay planes básicos, ambulatorios intensivos y un residencial de varón y está el conenio 2 que es el convenio específico para población infractora de ley y ahí tenemos programas en el medio cerrado que es el centro Iquique y en el medio libre, ya que son programas todos esos ambulatorios intensivos y convenio con las unidades de desintoxicación, unidades de corta estadía, pero es que hoy día debería tener futuro llamarse Unidades hospitalarias de internación psiquiátrica y tenemos el convenio 5 que es convenio general adolescentes que son para jóvenes que no son infractores de ley y ese es otro perfil...
#- http://bibliotecadigital.academia.cl/xmlui/bitstream/handle/123456789/5357/TTRASO%20591.pdf?sequence=1
#convenio N° 2 Infanto-Adolescente asociada a la ley de responsabilidad para tratamiento de drogas y alcohol como también el perfil de paciente correspondiente a convenio N° 5 de carácter más proteccionales
#a convenio N°5 población general infanto - adolescente 
