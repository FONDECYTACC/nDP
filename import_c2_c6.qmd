...
We generated an encrypted rownumber (`id_vers`), and ordered the first columns to be the RUN, the RUN under the assumption of a missing verification digit, and SENDA code.
