...
The file is located and named as: <<dd_display: "`c(pwd)'fiscalia_mariel_feb_2023_match_SENDA_miss_pris.dta" >>
...
misstable sum motivodeegreso_mod_imp_rec tr_modality edad_al_ing_1 sex_enc edad_ini_cons escolaridad_rec sus_principal_mod freq_cons_sus_prin condicion_ocupacional_cor policonsumo num_hijos_mod_joel_bin tenencia_de_la_vivienda_mod macrozona n_off_vio n_off_acq n_off_sud n_off_oth dg_cie_10_rec dg_trs_cons_sus_or clas_r porc_pobr sus_ini_mod_mvv ano_nac_corr con_quien_vive_joel fis_comorbidity_icd_10
<</dd_do>>
~~~~
...
~~~~
<<dd_do>>
misstable pat motivodeegreso_mod_imp_rec tr_modality edad_al_ing_1 sex_enc edad_ini_cons escolaridad_rec sus_principal_mod freq_cons_sus_prin condicion_ocupacional_cor policonsumo num_hijos_mod_joel_bin tenencia_de_la_vivienda_mod macrozona n_off_vio n_off_acq n_off_sud n_off_oth dg_cie_10_rec dg_trs_cons_sus_or clas_r porc_pobr sus_ini_mod_mvv ano_nac_corr con_quien_vive_joel fis_comorbidity_icd_10
<</dd_do>>
~~~~
...
<<dd_graph: saving("tto_2023_pris_m1.svg") width(800) replace>>
...
esttab matrix(mat_scho_test) using "mat_scho_test_02_2023_1_pris_m1.csv", replace
esttab matrix(mat_scho_test) using "mat_scho_test_02_2023_1_pris_m1.html", replace
...
<<dd_include: "${pathdata2}mat_scho_test_02_2023_1_pris_m1.html" >>
...
esttab matrix(mat_scho_test2) using "mat_scho_test_02_2023_2_pris_m1.csv", replace
esttab matrix(mat_scho_test2) using "mat_scho_test_02_2023_2_pris_m1.html", replace
...
<<dd_include: "${pathdata2}mat_scho_test_02_2023_2_pris_m1.html" >>
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_1_pris_m1.html" >>
...
<<dd_graph: saving("h_m_ns_rp6tvc2_pris_m1.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_stddiff_s_pris_m1.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_s_pris_m1.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_stdif_s2_pris_m1.svg") width(800) replace>>
...
<<dd_graph: saving("_figs/h_m_ns_rp6_stdif_rmst_pris_m1.svg") width(800) replace>>
