...
kable(size=10, format="markdown",caption= "Summary descriptives, by accused status")
```
<sup> Note. Continuous variables are presented as Medians and Percentiles 25 and 75 were shown; Categorical variables are presented as number (%)</sup>
:::
