...
if (grepl("CISS Fondecyt",path)==T){
    ...
    try(setwd(paste0(path)));load(paste0(gsub("SUD_CL","",gsub("2022","2019",path)),"/11.Rdata"))
  }
```
...
::: verysmall
```{r 0-sexo, echo=T, fig.align='center', layout="l-body-outset", message=T, error=T, eval=T}
`%>%`<- magrittr::`%>%`
#no definido
...
#rmarkdown::paged_table()
  kable(size=8, format="markdown",caption= "Summary descriptives, if sex is not defined (1)")
```
:::
...
::: verysmall
```{r 0-nat, echo=T, fig.align='center', layout="l-body-outset", message=T, error=T, eval=T}
message(paste0("Missing values in P.O. not replaceable by SENDAs values (both missing)= ",
Base_fiscalia_v6 %>% 
...
DT::datatable(#extensions = c('FixedColumns',"FixedHeader"), 
  ...
  DT::formatStyle(1:1e5,fontWeight= DT::styleRow(1, "bold"))
      format_cells(1, 1:9, "bold") %>%
kable(size=8, format="markdown",caption= "Summary descriptives, if nationality is not defined (1)")
```
:::
