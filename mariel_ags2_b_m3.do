...
<<dd_graph: saving("tto_2023_pris_m3.svg") width(800) replace>>
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_1_pris_m3.html" >>
...
<<dd_graph: saving("h_m_ns_rp6tvc2_pris_m3.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_stddiff_s_pris_m3.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_s_pris_m3.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_stdif_s2_pris_m3.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_stdif_rmst_pris_m3.svg") width(800) replace>>
...
~~~~
<<dd_do:nocommand>>
	estwrite _all using "mariel_feb_23_2_m3.sters", replace

	cap qui save "mariel_feb_23_2_m3.dta", all replace emptyok
<</dd_do>>
~~~~
