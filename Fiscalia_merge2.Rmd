...
if (grepl("CISS Fondecyt",path)==T){
    load("C:/Users/CISS Fondecyt/Mi unidad/Alvacast/SISTRAT 2022 (github)/10.Rdata")
  } else if (grepl("andre",path)==T){
    load("E:/Mi unidad/Alvacast/SISTRAT 2022 (github)/10.Rdata")
  } else if (grepl("E:",path)==T){
    load("E:/Mi unidad/Alvacast/SISTRAT 2022 (github)/10.Rdata")
  } else {
    load(paste0(gsub("SUD_CL","",gsub("2019","2022",path)),"/10.Rdata"))
  }
```
...
```{r bpmn2, echo=T, cache= T, paged.print=TRUE, eval=T, error=T, fig.align="center", dev.args = list(bg = 'white'), class.source = "badCode", class.output = "badCode"}
...
```{r fig1-agrupaterminos-fechnac, fig.align='center', fig.pos='H', fig.cap="Date of birth and suspicious of commiting a crime", echo=T, cache= T, paged.print=TRUE, eval=T, error=T, dpi=320}
...
paste0("Patients involved in criminal processes (RUCs) as accused were charged with an average of ",
       round(mean(charges_by_patients_jun22$tot_charges),1)," charged with an average of ", round(mean(charges_by_patients_jun22$n),1), " RUCs"), fill=T)
cat(
...
paste0("[CORRECTED] Percentage of patients involved in criminal processes as accused that")
paste0("had charges and resulted in full or partial incarceration: ",
...
paste0("Percentage of patients involved in criminal processes as accused that had charges and resulted in full")
paste0("or partial incarceration of those who Completed their first treatment (percentage discarded ongoing")
paste0("treatments): ",
scales::percent(
charges_by_patients_perc_pena_jun22 %>% 
    dplyr::left_join(dplyr::filter(CONS_C1_df_dup_SEP_2020[,c("hash_key","dup","fech_egres_imp","motivodeegreso_mod_imp")], dup==1), by=c("rut_enc_saf"="hash_key")) %>% 
...
paste0("Percentage of patients involved in criminal processes as accused that had charges and resulted in full")
paste0("or partial incarceration of those who did not Complete their first treatment (percentage discarded ")
paste0("ongoing treatments): ",
scales::percent(
