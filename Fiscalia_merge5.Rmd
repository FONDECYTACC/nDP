...
evalues.RR(est = 1.8193382, lo = 1.5723899, hi =2.1050704, rare=T)
#E-values 3.040261 2.521084      NA
evalues.RR(est = toRR(HR(1.6981313 , rare = FALSE)), 
           lo = toRR(HR(1.5911785, rare = FALSE)), 
           hi = toRR(HR(1.8122731, rare = FALSE)), 
           rare=T)
#RR       1.441756 1.378716 1.507518
#2.239818 2.101310       NA
evalues.RR(est = 1.4784520, lo = 1.3134946 , hi =1.6641257, rare=T)
# 2.319504 1.955190       NA
evalues.RR(est = toRR(HR(1.5377467, rare = FALSE)), 
           lo = toRR(HR(1.4629155, rare = FALSE)), 
           hi = toRR(HR(1.6164056 , rare = FALSE)), 
           rare=T)
# RR       1.346677 1.301161 1.393714
# E-values 2.029950 1.927147       NA

toHR(RR(2.029950,rare=F))
