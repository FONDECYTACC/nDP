...
estread using "mariel_feb_23_m1.sters"
...
~~~~
<<dd_do>>
cap qui save "mariel_ene_24_m1pre.dta", all replace emptyok
<</dd_do>>
~~~~ 
...
mata: st_sort_matrix("stats_124", 5) // 5 AIC, 6 BIC
global st_rownames : rownames stats_124
*di "$st_rownames"
esttab matrix(stats_124) using "testreg_aic_bic_mrl_24_1_m1.csv", replace
esttab matrix(stats_124) using "testreg_aic_bic_mrl_24_1_m1.html", replace
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_24_1_m1.html" >>
...
graph save "`c(pwd)'\_figs\h_m_ns_rp6tvc1_m1_pos_rev_diff.gph", replace
<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp6tvc1_m1_pos_rev_diff.svg") width(800) replace>>
...
// display function to order models by lowest AICs
mata: st_sort_matrix("stats_125", 5) // 5 AIC, 6 BIC
global st_rownames : rownames stats_125
*di "$st_rownames"
esttab matrix(stats_125) using "testreg_aic_bic_mrl_24_2_m1.csv", replace
esttab matrix(stats_125) using "testreg_aic_bic_mrl_24_2_m1.html", replace

estwrite m_24_2rp* using "mariel_ene_24_m1_fxd2_stpm2.sters", replace
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_24_2_m1.html" >>
...
graph save "`c(pwd)'\_figs\h_m_ns_rp6tvc1_m1_pos_rev_diff2.gph", replace
<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp6tvc1_m1_pos_rev_diff2.svg") width(800) replace>>
...
<<dd_do>>
/*
use "E:/Mi unidad/Alvacast/SISTRAT 2022 (github)/mariel_feb_23_m1.dta", clear
*/

qui noi stpm2 $covs_3b_pre_dum , scale(hazard) df(8) eform tvc(mot_egr_early mot_egr_late) dftvc(1) vce(cluster id_centro_factor)
...
stpm2_standsurv, at1(mot_egr_early 1 mot_egr_late 0) at2(mot_egr_early 0 mot_egr_late 0) timevar(times) ci contrast(difference) ///
     atvar(s_24_tr_comp s_24_early_drop) contrastvar(sdiff_24_tr_comp_early_drop)
...
stpm2_standsurv, at1(mot_egr_early 0 mot_egr_late 1) at2(mot_egr_early 0 mot_egr_late 0) timevar(times) ci contrast(difference) ///
     atvar(s_24_tr_comp0 s_24_late_drop) contrastvar(sdiff_24_tr_comp_late_drop)
...
stpm2_standsurv, at1(mot_egr_early 1 mot_egr_late 0) at2(mot_egr_early 0 mot_egr_late 1) timevar(times) ci contrast(difference) ///
     atvar(s_24_early_drop0 s_24_late_drop0) contrastvar(sdiff_24_early_late_drop)	

qui noi stpm2 $covs_3b_pre_dum , scale(hazard) df(8) eform tvc(mot_egr_early mot_egr_late) dftvc(1) vce(cluster comuna_factor)

stpm2_standsurv, at1(mot_egr_early 1 mot_egr_late 0) at2(mot_egr_early 0 mot_egr_late 0) timevar(times) ci contrast(difference) ///
     atvar(s_242_tr_comp s_242_early_drop) contrastvar(sdiff_242_tr_comp_early_drop)

stpm2_standsurv, at1(mot_egr_early 0 mot_egr_late 1) at2(mot_egr_early 0 mot_egr_late 0) timevar(times) ci contrast(difference) ///
     atvar(s_242_tr_comp0 s_242_late_drop) contrastvar(sdiff_242_tr_comp_late_drop)

stpm2_standsurv, at1(mot_egr_early 1 mot_egr_late 0) at2(mot_egr_early 0 mot_egr_late 1) timevar(times) ci contrast(difference) ///
     atvar(s_242_early_drop0 s_242_late_drop0) contrastvar(sdiff_242_early_late_drop)	

/*

. evalue hr  1.745549, lcl(1.648956) ucl( 1.8478) true(1) common figure
   E-value (point estimate): 2.300
   E-value (CI): 2.177

. evalue hr  1.584349, lcl(1.513223) ucl(1.658819)
   E-value (point estimate): 2.547
   E-value (CI): 2.394


. evalue hr 1.745549, lcl(1.655926) ucl(1.840022) true(1) common figure
   E-value (point estimate): 2.300
   E-value (CI): 2.186

. evalue hr 1.584349 , lcl(1.51665 ) ucl(1.655071) true(1) common figure
   E-value (point estimate): 2.092
   E-value (CI): 2.001
...
~~~~
<<dd_do>>
twoway  (rcap sdiff_24_tr_comp_early_drop_lci sdiff_24_tr_comp_early_drop_uci times, color(gs2%75) lcolor(gs2%75) ) ///             
                 (rcap sdiff_24_tr_comp_late_drop_lci sdiff_24_tr_comp_late_drop_uci times2, color(gs6%75) lcolor(gs6%75) ) ///
				 (rcap sdiff_24_early_late_drop_lci sdiff_24_early_late_drop_uci  times3, color(gs10%75) lcolor(gs10%75) ) ///
                 (scatter sdiff_24_tr_comp_early_drop times, mcolor(gs2) msymbol(O) mlcolor(gs2)) ///
                 (scatter sdiff_24_tr_comp_late_drop times2, mcolor(gs6) msymbol(O) mlcolor(gs2)) ///
				 (scatter sdiff_24_early_late_drop times3, mcolor(gs10) msymbol(O) mlcolor(gs2)) ///
                 ,xtitle("Years from treatment outcome") ///
                 ytitle("Standardized differences in the probability" "of contact with the justice system") ///
				 ...
				 graphregion(color(white) lwidth(large)) bgcolor(white) ///
				 plotregion(fcolor(white)) graphregion(fcolor(white) ) ///
                 name(clus_std_m1_pos_rev_diff2, replace)
graph save "`c(pwd)'\_figs\h_m_ns_rp6tvc1_m1_pos_rev_diff2_clus.gph", replace
<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp6tvc1_m1_pos_rev_diff2_clus.svg") width(800) replace>>
...
twoway  (rcap sdiff_242_tr_comp_early_drop_lci sdiff_242_tr_comp_early_drop_uci times, color(gs2%75) lcolor(gs2%75) ) ///             
				 ...
				 plotregion(fcolor(white)) graphregion(fcolor(white) ) ///
                 name(clus_std_m1_pos_rev_diff2, replace)
graph save "`c(pwd)'\_figs\h_m_ns_rp6tvc1_m1_pos_rev_diff2_clus2.gph", replace
<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp6tvc1_m1_pos_rev_diff2_clus2.svg") width(800) replace>>

<<dd_do: nocommand>>
/*
FORMA DE EXPORTAR LOS DATOS Y EL MARKDOWN

cap rm "E:/Mi unidad/Alvacast/SISTRAT 2022 (github)/analisis_mariel_ene_2024_stata_m1.html"
dyndoc "E:\Mi unidad\Alvacast\SISTRAT 2022 (github)\mariel_ags_b_m1_post_rev.do", saving("E:\Mi unidad\Alvacast\SISTRAT 2022 (github)\analisis_mariel_ene_2024_stata_m1.html") replace nostop 
copy "E:\Mi unidad\Alvacast\SISTRAT 2022 (github)\analisis_mariel_ene_2024_stata_m1.html" "E:\Mi unidad\Alvacast\SISTRAT 2022 (github)\_outputs\analisis_mariel_ene_2024_stata_m1.html", replace

cap rm "C:/Users/CISS Fondecyt/Mi unidad/Alvacast/SISTRAT 2022 (github)/analisis_mariel_ene_2024_stata_m1.html"
dyndoc "C:\Users\CISS Fondecyt\Mi unidad\Alvacast\SISTRAT 2022 (github)\mariel_ags_b_m1_post_rev.do", saving("C:\Users\CISS Fondecyt\Mi unidad\Alvacast\SISTRAT 2022 (github)\analisis_mariel_ene_2024_stata_m1.html") replace nostop 
copy "C:\Users\CISS Fondecyt\Mi unidad\Alvacast\SISTRAT 2022 (github)\analisis_mariel_ene_2024_stata_m1.html" "C:\Users\CISS Fondecyt\Mi unidad\Alvacast\SISTRAT 2022 (github)\_outputs\analisis_mariel_ene_2024_stata_m1.html", replace


cap rm "H:/Mi unidad/Alvacast/SISTRAT 2022 (github)/analisis_mariel_ene_2024_stata_m1.html"
dyndoc "H:\Mi unidad\Alvacast\SISTRAT 2022 (github)\mariel_ags_b_m1_post_rev.do", saving("H:\Mi unidad\Alvacast\SISTRAT 2022 (github)\analisis_mariel_ene_2024_stata_m1.html") replace nostop 
copy "H:\Mi unidad\Alvacast\SISTRAT 2022 (github)\analisis_mariel_ene_2024_stata_m1.html" "H:\Mi unidad\Alvacast\SISTRAT 2022 (github)\_outputs\analisis_mariel_ene_2024_stata_m1.html", replace
...
~~~~
<<dd_do>>
	estwrite _all using "mariel_ene_24_m1_fxd_vce.sters", replace

	cap qui save "mariel_ene_24_m1.dta", all replace emptyok
<</dd_do>>
~~~~
