...
.pandoc-table { /* Deb iese ponerle el 24-08-22 00.18 !important;  */
...
dplyr::select(rut_enc_saf, encontrado_como_imputado, fec_comision_simple, fec_cbiorelacion_simple, edad_ter_rel_imp, edad_comision_imp, imp_birth_date, gls_region, gls_materia, agrupa_terminos, obs) %>% 
  ...
  head(20) %>% 
  kable(size=10, format="markdown",caption= "Cases w/ crimes committed before 2010 (First 20 cases)") 
...
Base_fiscalia_v7 %>%
  ...
  dplyr::arrange(-diff_bet_ter_com)  %>% 
    head(20) %>%
  kable(size=10, format="markdown",caption= "Cases w/ Age of finishing of relationship before the crimes being committed (First 20 cases)") 
