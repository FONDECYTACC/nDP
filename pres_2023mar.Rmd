...
tasks <- c("Literature review", "Main statistic analysis", "Sensitivity analyses", "Progress report", "Final arrangements", "Manuscript read\nfor submission", "Presentation in\nscientific meetings")
...
dfr <- data.frame(
  ...
  end.date    = as.Date(c("2022-10-31", "2022-10-31", "2023-02-28", "2023-03-30","2023-06-30","2023-06-30","2023-06-30")),
...
ggplot(dfr, aes(x =start.date, xend= end.date, y=factor(name, levels = rev(levels(name))), yend = factor(name, levels = rev(levels(name))))) +
  ...
  geom_label(data=dfr, aes(x=mean_date, y=factor(name, levels = rev(levels(name))),  label = Actor), size=size_gplot*1, color="gray40",show.legend=F#,
    ...
    scale_x_date(date_breaks = "2 months",date_labels="%b '%y",limits=c(as.Date("2022-06-01"),as.Date("2023-08-02")))+
