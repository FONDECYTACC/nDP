...
The file is located and named as: <<dd_display: "`c(pwd)'fiscalia_mariel_feb_2023_match_SENDA_miss_pris2.dta" >>
...
<<dd_graph: saving("tto_2023_pris.svg") width(800) replace>>
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_1_pris.html" >>
...
<<dd_graph: saving("_figs/h_m_ns_rp6_stdif_rmst_pris.svg") width(800) replace>>
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_2_pris.html" >>
...
<<dd_graph: saving("h_m_ns_rp5_a_pris.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp5_stdiff_rmst_a_pris.svg") width(800) replace>>
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_3_pris.html" >>
...
<<dd_graph: saving("h_m_ns_rp5_22_b_pris.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp5_stdif_rmst_b_pris.svg") width(800) replace>>
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_4_pris.html" >>
...
<<dd_graph: saving("h_m_ns_rp5_22_c_pris.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp5_stdif_rmst_c_pris.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp5_stdif_s_abc_pris.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp5_stdif_rmst_abc_pris.svg") width(800) replace>>
