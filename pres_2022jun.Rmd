...
---
### Distribución geográfica (político-administrativa)

.pull-left[

.details-code[

```{r fig7_image-map_chile_regiones, echo=T, error=T, fig.align='center', fig.showtext=T, message=F, warning=F, fig.show='hide', results='hide'}
#, results='asis'
...
htmlwidgets::saveWidget(gg2_plot, paste0(sub("2019 \\(github\\)/SUD_CL","2022 \\(github\\)",path2),"/_figs/regional1.html"))
girafe_options(gg2_plot, opts_tooltip(placement="auto"), opts_sizing(rescale = T, width=.75))
...
```{r fig7_image-map_chile_comunas, echo=T, error=T, fig.align='center', fig.cap="% registros criminales por comuna (Metropolitana)", fig.showtext=T, message=FALSE, warning=FALSE, fig.show='hide', results='hide'}
#results='asis'
...
htmlwidgets::saveWidget(gg3_plot, paste0(sub("2019 \\(github\\)/SUD_CL","2022 \\(github\\)",path2),"/_figs/comunal1.html"))
girafe_options(gg3_plot, opts_tooltip(placement="auto"), opts_sizing(rescale = T, width=.75))
...
knitr::include_graphics(paste0(sub("2019 \\(github\\)/SUD_CL","2022 \\(github\\)",path2),"/_style/Logo nDP_color_hz_en.png"))
