...
The file is located and named as: <<dd_display: "`c(pwd)'fiscalia_mariel_feb_2023_match_SENDA_miss2.dta" >>
...
<<dd_graph: saving("tto_2023_m2.svg") width(800) replace>>
...
esttab matrix(mat_scho_test) using "mat_scho_test_02_2023_1_m2.csv", replace
esttab matrix(mat_scho_test) using "mat_scho_test_02_2023_1_m2.html", replace
...
<<dd_include: "${pathdata2}mat_scho_test_02_2023_1_m2.html" >>
...
esttab matrix(mat_scho_test2) using "mat_scho_test_02_2023_2_m2.csv", replace
esttab matrix(mat_scho_test2) using "mat_scho_test_02_2023_2_m2.html", replace
...
<<dd_include: "${pathdata2}mat_scho_test_02_2023_2_m2.html" >>
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_1_m2.html" >>
...
<<dd_graph: saving("h_m_ns_rp6tvc2_m2.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_stddiff_s_m2.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_s_m2.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_stdif_s2_m2.svg") width(800) replace>>
...
<<dd_graph: saving("h_m_ns_rp6_stdif_rmst_m2.svg") width(800) replace>>
...
esttab matrix(stats_2) using "testreg_aic_bic_mrl_23_2_m2.csv", replace
esttab matrix(stats_2) using "testreg_aic_bic_mrl_23_2_m2.html", replace

*m_stipw_nostag_rp5_tvcdf1 m_stipw_nostag_rp5_tvcdf1 confirmed
<</dd_do>>
~~~~

<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_2_m2.html" >>
...
graph save "`c(pwd)'\_figs\h_m_ns_rp5_a_m2.gph", replace

<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp5_a_m2.svg") width(800) replace>>
...
graph save "`c(pwd)'\_figs\h_m_ns_rp5_stdiff_rmst_a_m2.gph", replace
<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp5_stdiff_rmst_a_m2.svg") width(800) replace>>
...
esttab matrix(stats_3) using "testreg_aic_bic_mrl_23_3_m2.csv", replace
esttab matrix(stats_3) using "testreg_aic_bic_mrl_23_3_m2.html", replace
...
<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_3_m2.html" >>
...
graph save "`c(pwd)'\_figs\h_m_ns_rp5_22_b_m2.gph", replace

<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp5_22_b_m2.svg") width(800) replace>>
...
graph save "`c(pwd)'\_figs\h_m_ns_rp5_stdif_rmst_b_m2.gph", replace
<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp5_stdif_rmst_b_m2.svg") width(800) replace>>
...
esttab matrix(stats_4) using "testreg_aic_bic_mrl_23_4_m2.csv", replace
esttab matrix(stats_4) using "testreg_aic_bic_mrl_23_4_m2.html", replace

<</dd_do>>
~~~~

<<dd_include: "${pathdata2}testreg_aic_bic_mrl_23_4_m2.html" >>
...
graph save "`c(pwd)'\_figs\h_m_ns_rp5_22_c_m2.gph", replace

<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp5_22_c_m2.svg") width(800) replace>>
...
graph save "`c(pwd)'\_figs\h_m_ns_rp5_stdif_rmst_c_m2.gph", replace
<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp5_stdif_rmst_c_m2.svg") width(800) replace>>
...
twoway  (rarea sdiff_comp_vs_late_lci sdiff_comp_vs_late_uci tt, color(gs2%35)) ///
		...
		gr_edit yaxis1.major.label_format = `"%9.2f"'
graph save "`c(pwd)'\_figs\h_m_ns_rp5_stdif_s_abc_m2.gph", replace
<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp5_stdif_s_abc_m2.svg") width(800) replace>>
...
twoway  (rarea rmstdiff_comp_vs_late_lci rmstdiff_comp_vs_late_uci tt, color(gs2%35)) ///
		...
		gr_edit yaxis1.major.label_format = `"%9.2f"'
graph save "`c(pwd)'\_figs\h_m_ns_rp5_stdif_rmst_abc_m2.gph", replace
<</dd_do>>
~~~~

<<dd_graph: saving("h_m_ns_rp5_stdif_rmst_abc_m2.svg") width(800) replace>>
...
~~~~
<<dd_do:nocommand>>
	frame late: cap qui save "mariel_feb_23_m2_late.dta", all replace emptyok
	frame early: cap qui save "mariel_feb_23_m2_early.dta", all replace emptyok
	frame early_late: cap qui save "mariel_feb_23_m2_early_late.dta", all replace emptyok

	estwrite _all using "mariel_feb_23_m2.sters", replace

	cap qui save "mariel_feb_23_m2.dta", all replace emptyok
<</dd_do>>
~~~~
