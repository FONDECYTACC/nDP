...
```{r exp-surv3-prob-plot, eval=T, fig.align='center', message=F, echo=F, error=T, fig.align='center', fig.cap="", fig.retina=2, fig.cap="Differences in survival probabilities(up) and RMSTs(bottom) for time-to-condemnatory sentence(left) & imprisonment(right)"}
require(cowplot)
require(gridExtra)
require(coin)
require(magick)
