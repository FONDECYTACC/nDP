...
<ule>
  ...
  <li>Treatment admission year</li>
...
```{r exp-surv3-pris, echo=F, include=F, eval=T}
library(cowplot)
library(gridExtra)
library(coin)
library(magick)
...
```
```{r exp-surv3-plot, eval=T, fig.align='center', message=F, echo=F, error=T, fig.align='center', fig.cap="", fig.retina=2, fig.cap="Differences in survival probabilities (up) and RMSTs (down) for time-to-condemnatory sentence(left) & imprisonment(right)"}
