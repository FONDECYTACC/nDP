...
author_textcol: "#bf846f" #Colour of author text.
...
sectitle_boxshape: "3.5mm 0mm" #Changes the shape of the section title box.
...
```{css, echo=FALSE}
div.title_container{
   background-image: linear-gradient(#ff7f50 25%, #21177A); /* background-color: #21177A;*/
}

div.logo_left{
  background-image: linear-gradient(#ff7f50 25%, #21177A);/* background-color: #ff7f50; */
}
div.logo_right{
  background-image: linear-gradient(#ff7f50 25%, #21177A); /*background-color: #ff7f50; */
}
...
& & \mathrm{Treatment\ setting} \\
& & \mathrm{Sex} \\
& & \mathrm{Substance\ use\ onset\ age} \\
& & \mathrm{Educational\ attainment} \\
& & \mathrm{Primary\ substance\ At\ sdmission} \\
& & \mathrm{Primary\ substance\ at\ sdmission\ usage\ frequency} \\
& & \mathrm{Occupational\ status} \\
& & \mathrm{Poly-substance\ use} \\
& & \mathrm{Number\ of\ children\ (binary)} \\
...
& & \mathrm{Number\ of\ previous\ offenses\ (other)} \\
& & \mathrm{Psychiatric\ comorbidity} \\
& & \mathrm{Substance\ use\ severity} \\
& & \mathrm{Urban/rural\ municipallity\ of\ residence} \\
& & \mathrm{Percetage\ of\ proverty\ of\ the\ municipallity\ of\ residence} \\
& & \mathrm{Substance\ use\ onset} \\
& & \mathrm{Treatment\ admission\ year} \\
& & \mathrm{Cohabitation\ Status} \\
& & \mathrm{Physical\ comorbidity} \\
& & \mathrm{Age\ at\ admission\ to\ treatment(RCS)} \\
\end{eqnarray*}
$$
:::
<!----
