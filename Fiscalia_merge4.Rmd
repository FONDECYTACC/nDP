...
Base_fiscalia_v11
biostat3::survRate(Surv((age_offending_imp-edad_al_ing_1), !is.na(dateofbirth_imp)) ~ motivodeegreso_mod_imp_1, data=Base_fiscalia_v11)


mot_egreso_fit<- survfit(Surv(age_offending_imp-edad_al_ing_1,  !is.na(dateofbirth_imp)) ~motivodeegreso_mod_imp_1, data=Base_fiscalia_v11,
                               type      = "kaplan-meier",
                                error     = "greenwood",
                                conf.type = "log-log") 
