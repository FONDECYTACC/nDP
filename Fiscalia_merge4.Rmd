...
We took `Base_fiscalia_v9` (only offenders that had a final judgment as guilty)
...
```{r join4_SER, echo=T, fig.align='center', message=T, error=T, eval=F}
...
cat_vars_desc<- c("escolaridad_rec", "sus_principal_mod", "freq_cons_sus_prin", "compromiso_biopsicosocial", "tenencia_de_la_vivienda_mod", "dg_cie_10_rec", "dg_trs_cons_sus_or", "macrozona")
...
tbone_desc_merge4<-
CreateTableOne(vars= c(cont_vars_desc, cat_vars_desc, "cut_com_del", "cut_fec_nac"), data=  subset(Base_fiscalia_v13, select= c(cont_vars_desc, cat_vars_desc, "cut_com_del", "cut_fec_nac", "motivodeegreso_mod_imp_rec")), factorVars = c(catVars, "cut_com_del", "cut_fec_nac"), smd=T, strata=c("motivodeegreso_mod_imp_rec"), addOverall = T, includeNA=T, test=T)
