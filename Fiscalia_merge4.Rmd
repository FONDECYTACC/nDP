...
We discussed the nature of offenses with several professionals in the judiciary system and expert lawyers.
...
```{r exp-surv2, echo=T, fig.align='center', message=T, error=T, eval=T}
