...
We discarded relationships in which the offender was not the patient from SENDA. Also we restricted the analysis to the patients that had a final judgment as guilty ("SENTENCIA DEFINITIVA CONDENATORIA").
...
'nat_imp2' = 'country_b',
'nat_imp' = 'country_a')) %>% 
  dplyr::filter(grepl("CONDENATORIA",end_type)) %>% 
...
if(nrow(Base_fiscalia_v9)-nrow(Base_fiscalia_v8)>0){
...
::: controlly
```{r 2-exp-val, echo=T, fig.align='center', message=T, error=T, eval=T}
# Add cathegory "predatory ilegal acts": assault, robbery, burglary, larceny, forgery, stolen property) , as they may be related with drug use individuals.	ADD PROPERTY
# 	BURGLARY
# 	OTHER CRIMES AGAINST PROPERTY

#La fiscalía tiene una definición de delitos violentos: consideran delitos violentos: secuestro, sustracción, lesiones, robos, homicidios, cuasidelito por delitos de la salud. Por otro lado, no estudia delitos como tortura, maltrato, genocidio,
...
#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#_#
Base_fiscalia_v8 <- plyr::rename(Base_fiscalia_v8,
c('rut_enc_saf' = 'id',
'fec_nacimiento' = 'dateofbirth',
'pais' = 'country',
'sexo' = 'sex',
