...
The majority of cases had only  one relationship, and nearly 95% had only one offense (even if the number of relationships is greater) had only We showed details.
