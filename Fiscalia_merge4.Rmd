...
tab7_lab_aft_d2<-
    ...
    paste0("(p= ",format(nrow(dplyr::distinct(dplyr::filter(Base_fiscalia_v8, dplyr::case_when(!grepl("SI",encontrado_como_imputado)|(grepl("REPARATORIO|CONDICIONAL",gls_mottermino) & is.na(agrupa_terminos)) ~F, !grepl("SI",encontrado_como_imputado)|( grepl("REPARATORIO|SENTENCIA DEFINITIVA CONDENATORIA|240|MONIT", toupper(agrupa_terminos), ignore.case=F))~F, T~T)),rut_enc_saf)),big.mark=","),"; RUCs= ",
           format(nrow(dplyr::distinct(dplyr::filter(Base_fiscalia_v8, dplyr::case_when( !grepl("SI",encontrado_como_imputado)|(grepl("REPARATORIO|CONDICIONAL",gls_mottermino) & is.na(agrupa_terminos))~F, !grepl("SI",encontrado_como_imputado)|(grepl("REPARATORIO|SENTENCIA DEFINITIVA CONDENATORIA|240|MONIT", toupper(agrupa_terminos), ignore.case=F))~F, T~T)),ruc)), big.mark=","),";n= ",
           format(nrow(dplyr::filter(Base_fiscalia_v8, dplyr::case_when( !grepl("SI",encontrado_como_imputado)|(grepl("REPARATORIO|CONDICIONAL",gls_mottermino) & is.na(agrupa_terminos))~F, !grepl("SI",encontrado_como_imputado)|(grepl("REPARATORIO|SENTENCIA DEFINITIVA CONDENATORIA|240|MONIT", toupper(agrupa_terminos), ignore.case=F))~F, T~T))), big.mark=","),")")
